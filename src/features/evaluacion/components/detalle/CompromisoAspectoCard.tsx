      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
        <div className="min-w-0">
          ...
          <p className="mt-1 flex items-center gap-1.5 text-xs text-slate-600">
            ...
            Fecha límite: {formatDate(compromiso.fechaLimite)}
          </p>
        </div>

        <Link
          to={ruta}
          className="inline-flex shrink-0 items-center justify-center rounded-xl bg-slate-950 px-4 py-2.5 text-xs font-bold text-white transition hover:bg-cyan-700"
        >
          Abrir compromiso
        </Link>
      </div>
